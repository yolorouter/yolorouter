-- migrations/sqlite/00030_candidate_armed_at.sql
--
-- SQLite mirror of migrations/postgres/00030_candidate_armed_at.sql.
--
...
-- +goose Up
ALTER TABLE model_candidates ADD COLUMN armed_at TIMESTAMP;
