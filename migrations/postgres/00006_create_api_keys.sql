...
-- budget is integer micros (bigint, major-unit x 1e6, i.e. 6-decimal
-- precision) to avoid float drift on a cumulative hard cap.
--
-- +goose Up
CREATE TABLE api_keys (
    ...
    budget_limit_micros   BIGINT NULL,
    budget_spent_micros   BIGINT NOT NULL DEFAULT 0,
