-- migrations/postgres/00040_image_pricing.sql
--
...
-- always explain itself. Column semantics are shared with the sqlite twin.
...
-- +goose Down
ALTER TABLE model_candidates DROP COLUMN IF EXISTS billing_mode;
ALTER TABLE model_candidates DROP COLUMN IF EXISTS image_pricing_tiers;
ALTER TABLE request_logs DROP COLUMN IF EXISTS image_pricing_snapshot;
