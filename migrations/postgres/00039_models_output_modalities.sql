-- migrations/postgres/00039_models_output_modalities.sql
--
...
-- existing deployments keep routing exactly as they did. Column semantics are
-- shared with the sqlite twin.
