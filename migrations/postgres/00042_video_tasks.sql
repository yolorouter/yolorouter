-- migrations/postgres/00042_video_tasks.sql
--
...
-- admin frontend's editor produces. Column semantics are shared with the
-- sqlite twin.
...
CREATE TABLE video_tasks (
    ...
    destination_version    BIGINT NOT NULL DEFAULT 1,
    ...
    upstream_submitted_at  TIMESTAMPTZ NOT NULL,
    upstream_completed_at  TIMESTAMPTZ NULL,
...
ALTER TABLE model_candidates DROP COLUMN IF EXISTS video_pricing_tiers;
