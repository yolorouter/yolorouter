...
func TestExportRequestLogsCSVReturnsBOMAndHeaderAndRows(t *testing.T) {
	...
	if lines[0] != "request_id,created_at,status_class,status_code,username,model_name,provider_name,is_stream,key_switches,failovers,final_provider_model,duration_ms,input_tokens,output_tokens,cache_write_tokens,cache_read_tokens,billing_unit,image_count,image_unit_price,usage_seconds,cost_micros,cost_known,fail_reason" {
